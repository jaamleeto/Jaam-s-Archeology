...
public class JaamsArcheologyModSounds {
	...
	public static final RegistryObject<SoundEvent> GUARDIAN_IDOL_STARTED = REGISTRY.register("guardian_idol_started", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("jaams_archeology", "guardian_idol_started")));
	public static final RegistryObject<SoundEvent> GUARDIAN_IDOL_EXPIRES = REGISTRY.register("guardian_idol_expires", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("jaams_archeology", "guardian_idol_expires")));
	public static final RegistryObject<SoundEvent> ARTHROPODS_IDOL_STARTED = REGISTRY.register("arthropods_idol_started", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("jaams_archeology", "arthropods_idol_started")));
	public static final RegistryObject<SoundEvent> ARTHROPODS_IDOL_EXPIRES = REGISTRY.register("arthropods_idol_expires", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("jaams_archeology", "arthropods_idol_expires")));
}
