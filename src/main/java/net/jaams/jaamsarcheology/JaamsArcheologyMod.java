...
import net.jaams.jaamsarcheology.init.JaamsArcheologyModBlocks;
...
@Mod("jaams_archeology")
public class JaamsArcheologyMod {
	public static final Logger LOGGER = LogManager.getLogger(JaamsArcheologyMod.class);
	public static final String MODID = "jaams_archeology";

	public JaamsArcheologyMod() {
