...
public class PiglinIdolGlobalProcedure {
	@SubscribeEvent
	...
	public static void onLivingUpdate(LivingEvent.LivingTickEvent event) {
		...
		if (entity instanceof Piglin || entity instanceof PiglinBrute || entity instanceof ZombifiedPiglin) {
			...
			if (targetEntity != null && targetEntity.hasEffect(JaamsArcheologyModMobEffects.PIGMAN_VIGOR.get())) {
				mob.setTarget(null);
			}
		}
	}
	...
	private static void execute(@Nullable Event event, Entity entity, Entity targetEntity) {
		if (entity == null || targetEntity == null)
			return;
		if (entity instanceof Piglin || entity instanceof PiglinBrute || entity instanceof ZombifiedPiglin) {
			if (targetEntity instanceof LivingEntity livingTargetEntity && livingTargetEntity.hasEffect(JaamsArcheologyModMobEffects.PIGMAN_VIGOR.get())) {
